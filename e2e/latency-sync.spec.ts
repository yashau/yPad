...
test.describe("Latency Sync Tests - 3 Clients", () => {
  ...
  test("Race condition: Client1 types while initial PUT is in flight (high latency)", async ({
    browser,
    request,
  }) => {
  ...
  test("Concurrent insertions at SAME position (conflict resolution)", async ({
    browser,
    request,
  }) => {
